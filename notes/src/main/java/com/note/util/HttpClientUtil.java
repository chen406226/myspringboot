...
//		String url = "http://www.iyoule.com/book/4/";
//		String url = "http://api.map.baidu.com/geosearch/v3/nearby";
		String url = "https://book.qidian.com/info/1003354631";
		HttpClientUtil.init();
		try {
//			System.out.println(HttpClientUtil.callUrlGet(url, "UTF-8"));
			String searchHtml = HttpClientUtil.callUrlGet(url,"UTF-8");
			//获取dom并解析
			Document searchDocument = Jsoup.parse(searchHtml);
			System.out.print(searchDocument);
